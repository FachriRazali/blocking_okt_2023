...
<body>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-9">
            <textarea name="subjudul" id="subjudul" cols="5" ows="3"
    ...
    <div class="modal fade" id="editdata" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="row mb-3">
            <label for="status" c;ass="col-sm-3 col-formlabel">Status</label>
            <div class="col-sm-9">
                <select name="status" id="status" class="form-control">
                    <option value="">Pilih</option>
                    <option value="aktif">Aktif</option>
                    <option vlaue="tidak aktif">Tidak Aktif</option>
        </select>
        </div>
        </div>
        </div>
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" databs-dismiss="modal">Batal</button>
